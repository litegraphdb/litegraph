namespace Test.Automated
{
    ...
    internal static class Program
    {
        private static readonly HashSet<string> TransactionConcurrencyCaseIds = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            "Transactions.ProviderMatrix.SqliteCorrectness",
            "Transactions.ProviderMatrix.PostgresqlCorrectness",
            "Transactions.ProviderMatrix.SqliteHighConcurrencyReadWrite",
            "Transactions.ProviderMatrix.PostgresqlHighConcurrencyReadWrite",
            "Transactions.ProviderMatrix.PostgresqlSerializableConflict",
            "Transactions.ProviderMatrix.SqliteVectorSearchMutation",
            "Transactions.ProviderMatrix.PostgresqlVectorSearchMutation",
            "Transactions.Server.SqliteRestConcurrency",
            "Transactions.Server.PostgresqlRestConcurrency",
