    ...
    internal static class SetupQueries
    {
        internal static string CreateTablesAndIndices()
        {
            ...
            sql.AppendLine(
                ...
                + "apikey TEXT, "
                + "model VARCHAR(128), "
                + "contextwindowtokens INT NOT NULL DEFAULT 0, "
            ...
            sql.AppendLine(
                ...
                + "enablemutationtools INT NOT NULL DEFAULT 1, "
                + "maxtooliterations INT NOT NULL DEFAULT 50, "
                + "enablerag INT NOT NULL DEFAULT 1, "
                + "ragtopk INT NOT NULL DEFAULT 8, "
                + "ragscorethreshold REAL NOT NULL DEFAULT 0, "
                + "historyretentiondays INT NOT NULL DEFAULT 30, "
                + "createdutc VARCHAR(64), "
                + "lastupdateutc VARCHAR(64) "
                + ");");
