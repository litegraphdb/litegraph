...
export const SETTINGS_SCHEMA: SettingsSectionSchema[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { path: 'Logging.EnableColors', labelKey: 'enableColors', type: 'boolean' },
      { path: 'Logging.JsonLogOutput', labelKey: 'jsonLogOutput', type: 'boolean' },
      ...
      { path: 'Logging.Header', labelKey: 'logHeader', type: 'text' },
  ...
  },
  {
    ...
    fields: [
      ...
      { path: 'Observability.OtlpProtocol', labelKey: 'otlpProtocol', type: 'text' },
      { path: 'Observability.OtlpTimeoutMilliseconds', labelKey: 'otlpTimeoutMs', type: 'number' },
  ...
  },
  {
    ...
    fields: [
      ...
      { path: 'Rest.Ssl.MutuallyAuthenticate', labelKey: 'restSslMutualAuth', type: 'boolean' },
      { path: 'Rest.Ssl.AcceptInvalidAcertificates', labelKey: 'restSslAcceptInvalid', type: 'boolean' },
    ],
  },
  {
    id: 'litegraph',
    ...
    fields: [
      { path: 'LiteGraph.GraphRepositoryFilename', labelKey: 'graphRepositoryFilename', type: 'text' },
      { path: 'LiteGraph.MaxConcurrentOperations', labelKey: 'maxConcurrentOperations', type: 'number' },
      { path: 'LiteGraph.InMemory', labelKey: 'litegraphInMemory', type: 'boolean' },
      { path: 'LiteGraph.Transactions.MaxOperations', labelKey: 'txMaxOperations', type: 'number' },
      { path: 'LiteGraph.Transactions.MaxTimeoutSeconds', labelKey: 'txMaxTimeoutSeconds', type: 'number' },
    ],
  },
  {
    id: 'database',
    ...
    fields: [
      ...
      { path: 'LiteGraph.Database.Filename', labelKey: 'databaseFilename', type: 'text' },
      { path: 'LiteGraph.Database.InMemory', labelKey: 'databaseInMemory', type: 'boolean' },
      ...
      { path: 'LiteGraph.Database.Schema', labelKey: 'databaseSchema', type: 'text' },
      { path: 'LiteGraph.Database.MaxConnections', labelKey: 'databaseMaxConnections', type: 'number' },
      { path: 'LiteGraph.Database.CommandTimeoutSeconds', labelKey: 'databaseCommandTimeout', type: 'number' },
    ],
  },
  {
    id: 'storage',
    titleKey: 'storage',
    applies: 'restart',
    serverSection: 'Storage',
    fields: [
      { path: 'Storage.BackupsDirectory', labelKey: 'backupsDirectory', type: 'text' },
    ],
  },
  {
    id: 'security',
